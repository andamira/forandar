...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JS_CONST: {
      "^": "Object;code",
      code$0: function($receiver) {
        return this.code.call$0();
      }
    }
    ...
    _Deserializer: {
      ...
      }, "call$1", "get$deserialize", 2, 0, 2, 1],
    ...
    }, "call$2", "core_Comparable_compare$closure", 4, 0, 11],
    ...
    NoSuchMethodError_toString_closure: {
      "^": "Closure:10;_core$_box_0,_captured_sb_1",
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 12, 2],
  ...
  }], ["forandar", "../web/main.dart",, Q, {
    "^": "",
    main: [function() {
      var config, forth, t1, t2, t3, test, t4, t5, t6;
      config = Q.loadConfiguration();
      forth = new Q.VirtualMachine(null, null, null, null, null, null);
      t1 = new Q.LifoStack(null, 256, 0);
      t1.data = new Uint32Array(H._checkLength(256));
      forth.dataStack = t1;
      t1 = config.option;
      t2 = t1.$index(0, "dataStackSize");
      t3 = new Q.LifoStack(null, t2, 0);
      t3.data = new Uint32Array(H._checkLength(t2));
      forth.dataStack = t3;
      t3 = t1.$index(0, "returnStackSize");
      t2 = new Q.LifoStack(null, t3, 0);
      t2.data = new Uint32Array(H._checkLength(t3));
      forth.returnStack = t2;
      t2 = t1.$index(0, "controlStackSize");
      t3 = new Q.LifoStack(null, t2, 0);
      t3.data = new Uint32Array(H._checkLength(t2));
      forth.controlStack = t3;
      t1.$index(0, "dataSpaceSize");
      forth.dataSpace = new Q.DataSpace();
      t1.$index(0, "codeSpaceSize");
      forth.codeSpace = new Q.DataSpace();
      t1 = new Q.Dictionary(P.SplayTreeMap$(null, null, null, null), [], forth);
      t1.includeStandardPrimitives$0();
      t1.includeExtendedPrimitives$0();
      forth.dict = t1;
      test = new Q.TempTests(forth);
      t1 = forth.dataStack;
      test.header$3(0, "stack", t1, "forth.dataStack");
      P.print("length: " + t1.data.length + " cells, " + H.S(t1.data.byteLength) + " bytes");
      P.print("----------------");
      t1.Push$1(82);
      P.print("Push(82) >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Push$1(25);
      P.print("Push(25) >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Push$1(11);
      P.print("Push(11) >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Push$1(3);
      P.print("Push(11) >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Rot$0();
      P.print("Rot() >\t\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.RotCC$0();
      P.print("Rotcc() >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Over$0();
      P.print("Over() >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      P.print("Pop() > " + H.S(t1.Pop$0()) + "\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Swap$0();
      P.print("Swap() >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Dup$0();
      P.print("Dup() >\t\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t2 = t1.size;
      if (t2 > 4) {
        t3 = t1.data;
        t4 = t2 + 1;
      ...
      P.print("Pick(4) >\t" + ("(" + t2 + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Nip$0();
      P.print("Nip() >\t\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      P.print("Pop() > " + H.S(t1.Pop$0()) + "\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      t1.Tuck$0();
      P.print("Tuck() >\t" + ("(" + t1.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t1.data, 0, t1.size))));
      P.print("<<<<<<<<<<<<<<<< /stack");
      test.TestDictionary$2(forth.dict, "forth.dict");
    }, "call$0", "forandar__main$closure", 0, 0, 1],
    loadConfiguration: function() {
      var t1, c;
      t1 = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [null, null]);
      c = new Q.Configuration(t1);
      t1.$indexSet(0, "dataStackSize", 256);
      t1.$indexSet(0, "returnStackSize", 32);
      t1.$indexSet(0, "controlStackSize", 32);
      t1.$indexSet(0, "dataSpaceSize", 1024);
      t1.$indexSet(0, "codeSpaceSize", 1024);
      if ($.$get$context().hasProperty$1("forandar"))
        t1.forEach$1(0, new Q.loadConfiguration_closure(c));
      return c;
    },
    Word: {
      "^": "Object;name>,st<,isImmediate<,isCompileOnly<,hasCompleted,code",
      code$0: function($receiver) {
        return this.code.call$0();
      }
    },
    Dictionary: {
      "^": "Object;wordsMap,wordsList,vm",
      addWord$4: function(str, isImmediate, isCompileOnly, f) {
        var t1 = this.wordsList;
        t1.push(new Q.Word(str, t1.length + 1, false, false, null, f));
        this.wordsMap.$indexSet(0, str, C.JSArray_methods.get$last(t1));
      },
      includeStandardPrimitives$0: function() {
        this.addWord$4("INTERPRET", false, false, new Q.Dictionary_includeStandardPrimitives_closure());
        this.addWord$4(".", false, false, new Q.Dictionary_includeStandardPrimitives_closure0());
        this.addWord$4(".S", false, false, new Q.Dictionary_includeStandardPrimitives_closure1());
        var t1 = this.vm;
        this.addWord$4("DUP", false, false, t1.dataStack.get$Dup());
        this.addWord$4("?DUP", false, false, new Q.Dictionary_includeStandardPrimitives_closure2(this));
        this.addWord$4("DROP", false, false, t1.dataStack.get$Drop());
        this.addWord$4("OVER", false, false, t1.dataStack.get$Over());
        this.addWord$4("SWAP", false, false, t1.dataStack.get$Swap());
        this.addWord$4("ROT", false, false, t1.dataStack.get$Rot());
        this.addWord$4("-ROT", false, false, t1.dataStack.get$RotCC());
        this.addWord$4("NIP", false, false, t1.dataStack.get$Nip());
        this.addWord$4("TUCK", false, false, t1.dataStack.get$Tuck());
        this.addWord$4(">R", false, false, new Q.Dictionary_includeStandardPrimitives_closure3(this));
        this.addWord$4("IMMEDIATE", false, false, new Q.Dictionary_includeStandardPrimitives_closure4(this));
      },
      includeExtendedPrimitives$0: function() {
        this.addWord$4(">NAME", false, false, new Q.Dictionary_includeExtendedPrimitives_closure());
        this.addWord$4("NAME>STRING", false, false, new Q.Dictionary_includeExtendedPrimitives_closure0());
        this.addWord$4("ID.", false, false, new Q.Dictionary_includeExtendedPrimitives_closure1());
      }
    },
    Dictionary_includeStandardPrimitives_closure: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    Dictionary_includeStandardPrimitives_closure0: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    Dictionary_includeStandardPrimitives_closure1: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    Dictionary_includeStandardPrimitives_closure2: {
      "^": "Closure:0;_captured_this_0",
      call$0: function() {
        var t1 = this._captured_this_0.vm.dataStack;
        if (t1.size > 0)
          t1.Dup$0();
      }
    },
    Dictionary_includeStandardPrimitives_closure3: {
      "^": "Closure:0;_captured_this_1",
      call$0: function() {
        var t1 = this._captured_this_1.vm;
        t1.returnStack.Push$1(t1.dataStack.Pop$0());
      }
    },
    Dictionary_includeStandardPrimitives_closure4: {
      "^": "Closure:0;_captured_this_2",
      call$0: function() {
        C.JSArray_methods.get$last(this._captured_this_2.wordsList).set$isImmediate(true);
      }
    },
    Dictionary_includeExtendedPrimitives_closure: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    Dictionary_includeExtendedPrimitives_closure0: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    Dictionary_includeExtendedPrimitives_closure1: {
      "^": "Closure:0;",
      call$0: function() {
      }
    },
    ...
    loadConfiguration_closure: {
      "^": "Closure:3;_captured_c_0",
      call$2: function(key, value) {
        var newValue, t1;
        newValue = J.$index$asx(J.$index$asx(J.$index$asx($.$get$context(), "forandar"), "config"), key);
        if (newValue != null && !J.$eq$(newValue, value)) {
          window;
          t1 = "Override config.option['" + H.S(key) + "'] " + H.S(value) + " > " + H.S(newValue);
          if (typeof console != "undefined")
            console.info(t1);
          this._captured_c_0.option.$indexSet(0, key, newValue);
        }
      }
    },
    Stack: {
      "^": "Object;",
      toString$0: function(_) {
        return "(" + this.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(this.data, 0, this.size));
      }
    },
    LifoStack: {
      "^": "Stack;data,maxSize,size",
      Drop$0: [function() {
        var t1 = this.size;
        if (t1 > 0)
          this.size = t1 - 1;
      }, "call$0", "get$Drop", 0, 0, 1],
      Dup$0: [function() {
        var t1, t2, t3, t4;
        t1 = this.size;
        if (t1 > 0) {
      ...
      Rot$0: [function() {
        ...
        t1 = this.size;
        if (t1 > 2) {
          t = C.NativeUint32List_methods.sublist$2(this.data, t1 - 3, t1);
          t1 = this.data;
          t2 = this.size;
          t3 = t2 - 1;
          t4 = t.length;
      ...
      }, "call$0", "get$Tuck", 0, 0, 1]
    },
    TempTests: {
      "^": "Object;vm",
      header$3: function(_, str, e, $name) {
        var t1;
        window;
        t1 = "\n>>>>>>TEST>>>>>> " + str;
        if (typeof console != "undefined")
          console.info(t1);
        P.print("\"" + $name + "\" " + J.toString$0$(e));
      },
      TestDictionary$2: function(t, $name) {
        var t1, t2, t3;
        this.header$3(0, "dictionary", t, $name);
        t1 = t.wordsMap;
        P.print("n\u00ba words: " + t1._count + " in map, " + t.wordsList.length + " in list");
        P.print("----------------");
        t1.forEach$1(0, new Q.TempTests_TestDictionary_closure());
        P.print("----------------");
        J.code$0$x(t1.$index(0, "OVER"));
        t2 = this.vm;
        t3 = t2.dataStack;
        P.print("OVER >\t\t" + ("(" + t3.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t3.data, 0, t3.size))));
        J.code$0$x(t1.$index(0, "?DUP"));
        t2 = t2.dataStack;
        P.print("?DUP >\t\t" + ("(" + t2.size + ") " + C.NativeUint32List_methods.toString$0(C.NativeUint32List_methods.sublist$2(t2.data, 0, t2.size))));
        P.print("<<<<<<<<<<<<<<<< /dictionary");
      }
    },
    TempTests_TestDictionary_closure: {
      "^": "Closure:3;",
      call$2: function(key, value) {
        var t1 = "" + value.get$st() + "\t" + H.S(J.get$name$x(value));
        value.get$isImmediate();
        value.get$isCompileOnly();
        P.print(t1 + "\t  ");
      }
    },
    VirtualMachine: {
      "^": "Object;dict,dataStack,returnStack,controlStack,dataSpace,codeSpace"
    },
    DataSpace: {
      "^": "Object;"
    }
  ...
  J.code$0$x = function(receiver) {
    return J.getInterceptor$x(receiver).code$0(receiver);
  };
...
;
  ...
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.Object, args: [,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(Q.forandar__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(Q.forandar__main$closure(), a);
